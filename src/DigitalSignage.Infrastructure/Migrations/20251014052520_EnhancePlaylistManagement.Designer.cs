...
namespace DigitalSignage.Infrastructure.Migrations
{
    ...
    [Migration("20251014052520_EnhancePlaylistManagement")]
    partial class EnhancePlaylistManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalSignage.Domain.Entities.Schedule", b =>
                {
                    ...
                    b.ToTable("schedules", null, t =>
                        {
                            t.HasCheckConstraint("CK_Schedule_Source", "source IN ('Default', 'API', 'Import', 'Template', 'Bulk', 'System')");
                        });
                });
